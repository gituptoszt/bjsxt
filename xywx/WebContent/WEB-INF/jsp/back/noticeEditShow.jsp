...
<body class="childrenBody"> 
	<form class="layui-form">  
		...
		<div class="layui-form-item">
			...
			<input type="file" class="layui-upload-file fileUpload" lay-title="修改图片" name="file">
			<!-- <img src="" class="" id="userFace"
				style="display: inline-block;width:  200px; height: 200px;"> -->
			<div id="put_img">
				<label class="layui-form-label"></label>
				<img src="${obj.img}" class="" id="userFace" style="display:block;width:  200px; height: 200px;">
			</div>
		</div>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/noticeEditShow.js"></script>
</body>
</html>