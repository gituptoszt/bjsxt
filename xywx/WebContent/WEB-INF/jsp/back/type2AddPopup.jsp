...
<body class="childrenBody"> 
	<form class="layui-form">  
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input newsName" maxlength="20" name="title" value="" lay-verify="required">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">		
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input newsTime" name="set_time" value=""lay-verify="required|date" onclick="layui.laydate({elem:this})"> 
				</div>
			</div>
		</div> 
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<textarea class="layui-textarea text_summary"></textarea>
			</div>
		</div>
		<div class="layui-form-item">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/workTimeLineAdd.js"></script>
