...
<body class="childrenBody">
	<blockquote class="layui-elem-quote works_search">
		...
		<div class="layui-inline">
			<a class="layui-btn layui-btn-normal newsAdd_btn">添加一级类型</a>
		</div>
		<!-- <div class="layui-inline">
			<a class="layui-btn layui-btn-normal newsAdd_btn2">添加二级类型</a>
		</div> -->
		<div class="layui-inline">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/typeListShow.js"></script>  
</body>
</html>