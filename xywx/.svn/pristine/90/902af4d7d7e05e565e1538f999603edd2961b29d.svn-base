...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css_pc/pcLogin2.css" media="all" />    
</head> 
<body>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js_pc/pcLogin.js"></script>
</body>
</html>