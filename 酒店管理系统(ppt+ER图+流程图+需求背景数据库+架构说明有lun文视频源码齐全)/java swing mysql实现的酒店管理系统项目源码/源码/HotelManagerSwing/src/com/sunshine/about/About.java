...
implements ActionListener {
	...
	public About (JFrame frame) {
		...
		fee = new JLabel ("<html>技术支持: http://programmer.ischoolbar.com/<br>版权所有  (C) 2018   【猿来入此】 Corporation.</html>");
		tit = new JLabel ("        欢 迎 使 用 酒 店 管 理 系 统");
		ver = new JLabel ("版本:  2018 Bate        ");
		user= new JLabel ("软件用户:  " + sunini.getIniKey("UserName"));
		co	= new JLabel ("                         所属团队:【猿来入此】");
		boss= new JLabel ("       【猿来入此】于2018年4月3日修订     ");
		temp= new JLabel ("       ");
